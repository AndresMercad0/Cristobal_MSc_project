...
> **Note:** Row counts and data quality statistics vary between snapshots as the collection period grows. The statistics listed in the [Data Quality](#data-quality-and-processing-notes) section below correspond to the `10_months_data_Cristobal` snapshot and will be updated with each new release.
...
### High-Cost Station Data Quality (`10_months_data_Cristobal`)
